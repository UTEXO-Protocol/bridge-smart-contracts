...
contract RGBVerifierTest is Test {
    ...
    function test_verify_revertsWhenLatestNotFresh() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(RGBVerifier.RelayNotFresh.selector, 2, MAX_LATEST_CONF));
    ...
    function test_verify_revertsWhenGapTooSmall() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(RGBVerifier.InsufficientConfirmationGap.selector, 6, 4, 5));
